...
static uint32_t pwm_last_interrupt_time = 0;
static uint32_t last_interrupt_time = 0;
static const uint32_t debounce_time = 50; // 50 毫秒去抖动时间
static int fan_mos = 0;
...
int main(void)
{
    ...
    HAL_GPIO_WritePin(FAN_MOS_GPIO_Port,FAN_MOS_Pin, SET);
    HAL_GPIO_WritePin(ARGB_MOS_GPIO_Port,ARGB_MOS_Pin, SET);
    /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOB, FAN_MOS_Pin | ARGB_MOS_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pins : FAN_MOS_Pin ARGB_MOS_Pin */
    GPIO_InitStruct.Pin = FAN_MOS_Pin | ARGB_MOS_Pin;
