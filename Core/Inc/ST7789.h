...
/* choose whether you  use DMA or not */
#define USE_DMA

// #define INVON


/* If you need CS control, comment below*/
//#define CFG_NO_CS

/* Pin connection*/
#define ST7789_RST_PORT SPI1_RS_GPIO_Port
#define ST7789_RST_PIN  SPI1_RS_Pin
#define ST7789_DC_PORT  SPI1_DC_GPIO_Port
#define ST7789_DC_PIN   SPI1_DC_Pin

#ifndef CFG_NO_CS
#define ST7789_CS_PORT  SPI1_CS_GPIO_Port
...
void ST7789_DrawCircleCenter(uint16_t x_center, uint16_t y_center, uint16_t radius, uint16_t color);
void ST7789_DrawFilledCircleCenter(uint16_t x_center, uint16_t y_center, uint16_t radius, uint16_t color);
